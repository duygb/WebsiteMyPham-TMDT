                                                ...
                                                <form action="login" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" name="name" value="<%=request.getParameter("name")==null?"":request.getParameter("name") %>"
                                                               placeholder="Email hoặc số điện thoại" id="input-email"
                                                               class="form-control">
                                                    </div>
                                                    <div class="form-groups">
                                                        <input type="password" name="password" value=""
                                                               ...
                                                               class="form-control">
                                                        <a class="lg_gotpas"
                                                           href="qmk.jsp">Quên mật
                                                            khẩu? (Forgot Password)</a></div>
                                                    <input type="submit" value="Đăng nhập" class="submit">
                                                    <div class="text-center"><b>Bạn chưa có tài khoản? <a
                                                            href="dangky.jsp"
                                                            class="lg_register">Đăng ký</a></b></div>
                                                </form>
                                            </div>
                                            <div class="bottom_box">
                                                <label>Đăng nhập bằng </label>
                                                <button type="button" class="btn btn-lg btn-fb"><i
                                                        class="fa fa-facebook-f pr-1"></i> Facebook
                                                </button>
                                                <button type="button" class="btn btn-gplus"><i
                                                        class="fa fa-google-plus-g pr-1"></i> Google +
                                                </button>
                                            </div>
                                        </div>
                                    </div>

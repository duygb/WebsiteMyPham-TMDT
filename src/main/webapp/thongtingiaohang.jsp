                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 center-column " id="content">
                                            ...
                                            <form method="get" action="Hash">
                                                ...
                                                <div class="col-sm-5  col-xs-12 panel-np-right">
                                                        ...
                                                        <div id="ar-right-1">
                                                            <div class="panel-body"><div class="row">
                                                                    ...
                                                                    <fieldset id="payment-address">
                                                                        <div id="payment-new" class="row" style="display: block;">
                                                                            <div class="form-group col-sm-12 required">
                                                                                ...
                                                                                <input type="text" name="fullName" value="" placeholder="Họ và tên:" id="input-payment-firstname" class="form-control" required="" autocomplete="billing given-name">
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group col-sm-12 required custom-field" data-sort="2">
                                                                                ...
                                                                                <input type="text" name="phone" value="" placeholder="Điện thoại:" id="input-payment-custom-field1" class="form-control">
                                                                            </div>
                                                                            <div class="form-group col-sm-12 required custom-field">
                                                                                        <label class="control-label" for="input-payment-custom-field1">Tinh:</label>
                                                                                        <input type="text" name="contry" value="" placeholder="Tỉnh:" id="input-payment-country" class="form-control" autocomplete="billing country">
                                                                            </div>
                                                                            <div class="form-group col-sm-12">
                                                                                <label class="control-label" for="input-payment-address-1">Địa chỉ:</label>
                                                                                <input type="text" name="address" value="" placeholder="Địa chỉ:" id="input-payment-address-1" class="form-control" required="" autocomplete="billing street-address">
                                                                            </div>
                                                                ...
                                                                <div class="hidden-xs_">
                                                                    ...
                                                                    <p><textarea name="note" rows="3" class="form-control"></textarea></p>
                                                                </div>
                                                                <div class="buttons clearfix">
                                                                    <div class="pull-right">
                                                                        <input type="submit" value="Tiếp tục" id="button-address" data-loading-text="Đang Xử lý..." class="btn btn-primary">
                                                ...
                                                <div class="col-sm-7 col-xs-12 panel-np-left pull-right">
                                                                        ...
                                                                        <c:forEach items="${data}" var="d">
                                                                            <tr>
                                                                                ...
                                                                                <td class="product-subtotal">${d.price*d.quantity}<sup>đ</sup></td>
                                                                                    ...
                                                                                    <%--                                                           <% i += a;%>--%>
                                                                                <td class="remove"><a   href="<c:url value="/deleteCart?id=${d.id}"></c:url>" onclick="" class="btn-close" >

            ...
            <div class="container">
                <div class="row justify-content-around">
                    <form action="#" class="col-md-6 bg-light p-3 my-3" method="post">
                        <h1 class="text-center h3 py-3">Nhập key</h1>
                        <div style=" display: flex; width: 500px;">
                            <div class="form-group" style=" display: flex; width: 500px;">
                                <label for="key" style="width: 200px;">Nhập mã key</label>
                                <input type="text" name="key" id="key" class="form-control" >
                                <div style="text-align: center" id="chosse">
                                    <button title="CHOSSE" style="width: 100px; height: 30px; border-radius: 2px">CHOSSE
                                        <input hidden style="text-align: center" type="file" id="file-upload" required autocomplete="off" title=" " />
                                    </button>
                                </div>
                            </div>
                        </div>
                        <input type="submit" value="Xác nhận" class="btn btn-primary btn-block">
                        <p class="text-center mt-3">Bạn chưa có key? <a href="create-key.jsp">Tạo key</a></p>
...
<script>
    ...
    const filetext = document.querySelector("#key");
    btnChosse  = document.querySelector("#chosse");

    btnChosse.addEventListener("click", () => {
        fileUpload.click();

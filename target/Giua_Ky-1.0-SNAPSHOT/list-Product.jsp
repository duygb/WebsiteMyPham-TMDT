                                                                        ...
                                                                        <div class="product-grid">
                                                                            <div class="row">
                                                                                ...
                                                                                <%
                                                                                    ...
                                                                                    int total = new ProductEntity().getCount();
                                                                                    ...
                                                                                    List<Product> list = new ProductEntity().getShop(first, last);
                                                                                                ...
                                                                                                <div class="name"
                                                                                                    ...
                                                                                                    <div class="only-hover">
                                                                                                        <%--                                                                                                <c:url value="/cart/add?id=${p.id}"></c:url>--%>
                                                                                                            <input style="display: none" name="getID" value="<%=item.getId()%>">
                                                                                                            <a href="AddCart?id=<%=item.getId()%>" id="<%=item.getId()%>" onclick="addCart(${p.id}; addProduct(${p.img}), ${p.price}, ${p.title}, ${caption});"
                                                                                                             class="button">Mua
                                                                                                            hàng
                                                                                                        </a></div>
                                                                                            </div>
                                                                                ...
                                                                                <ul class="pagination">
                                                                                    ...
                                                                                    %>
                                                                                    <li class="page-item"><a class="page-link" href="list-Product.jsp?pages=<%=back%>"><i>Truoc</i></a></li>
                                                                                    <%
                                                                                        //Button Number pages
                                                                                        int loop = 0, num = 0;
                                                                                        if ((total / 4) % 2 == 0) {
                                                                                    ...
                                                                                    <li class="page-item active"><a class="page-link" href="list-Product.jsp?pages=<%=i%>"><%=i%></a></li>
                                                                                    <%} else {%>
                                                                                    <li class="page-item"><a class="page-link" href="list-Product.jsp?pages=<%=i%>"><%=i%></a> </li>
                                                                                    ...
                                                                                    %>
                                                                                    <li ><a href="list-Product.jsp?pages=<%=next%>"><i class="next"></i>Sau</a></li>
                                                                                </ul>
                                                                            </div>
